 ...
 *  REMARKS:
 * 
 *  Every aligner plugin should have two entries in the manifest file:
...
public final class AlignerLoader extends ClassLoader
{
     ...
     *  @return
     */
    public IAligner loadPlugin(String strPlugin)
    {
        ...
        try
        {
            ...
            IAligner aligner = (IAligner)c.newInstance();
            return aligner;
        }
        catch (Exception e)
        {
