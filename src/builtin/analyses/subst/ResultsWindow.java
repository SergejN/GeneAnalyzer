...
public class ResultsWindow extends javax.swing.JFrame
{
     ...
     *  @param bCds
     */
    public void setResults(String strContent, boolean bCds)
    {
        ...
        if(bCds)
        {
            ...
            model.addColumn("C<->T");
            model.addColumn("G<->T");
            model.addColumn("Transitions");
            model.addColumn("Transversions");
            model.addColumn("");
            model.addColumn("Nonsyn. sites");
            model.addColumn("A<->C");
            model.addColumn("A<->G");
            model.addColumn("A<->T");
            model.addColumn("C<->G");
    ...
    private void initComponents() {
        ...
        setTitle("Substitutions count analysis");
