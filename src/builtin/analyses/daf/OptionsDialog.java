...
public class OptionsDialog extends javax.swing.JDialog 
{
    ...
    public OptionsDialog(String[] pops, String[] regs) 
    {
        ...
        for(String s:regs)
        {
            // If there are at least one exon, enable CDS and FFD.
    ...
    private void initComponents() {
        ...
        jcbListFreqs = new javax.swing.JCheckBox();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jcOut, 0, 202, Short.MAX_VALUE)
                    .addComponent(jcPop, 0, 202, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        buttonGroup1.add(jrbCds);
        jrbCds.setText("Full CDS (nonsynonymous substitutions only)");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(21, 21, 21)
                        .addComponent(jeRange, javax.swing.GroupLayout.PREFERRED_SIZE, 253, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jcbListFreqs.setSelected(true);
        jcbListFreqs.setText("List single frequencies");
        ...
        jLabel6.setText("<html>Since the sample size is not constant, the frequency of the derived<br>mutations can be calculated two ways:");

        buttonGroup3.add(jrbSizeConstant);
        jrbSizeConstant.setText("Sample size is allways the number of strains");

        buttonGroup3.add(jrbSizeVariable);
        jrbSizeVariable.setSelected(true);
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    ...
    else if(!jcbShow.isSelected())
    {
        JOptionPane.showMessageDialog(null,
                                      ...
                                      "Derived allele frequency analysis",
    ...
    if(jcbRange.isSelected())
    {
        ...
        ao.sites = null;
    ao.bSizeConst = jrbSizeConstant.isSelected();
    ao.bListFreqs = jcbListFreqs.isSelected();
...
private void jrbFfdItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jrbFfdItemStateChanged
    ...
    if(jrbFfd.isSelected()) 
    {
        ...
        jcbCombine.setEnabled(false);
        jcbCombine.setSelected(false);
...
private void jcbRangeItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jcbRangeItemStateChanged
    ...
    private javax.swing.JCheckBox jcbListFreqs;
